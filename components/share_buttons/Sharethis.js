...
class InlineFollowButtons extends React.PureComponent {
  constructor(props) {
    super(props);
...
class InlineShareButtons extends React.PureComponent {
  constructor(props) {
    super(props);
    this.buttons = React.createRef();
  }
...
class InlineReactionButtons extends React.PureComponent {
  constructor(props) {
    super(props);
    this.buttons = React.createRef();
  }
...
class StickyShareButtons extends React.PureComponent {
  constructor(props) {
    super(props);
    this.buttons = React.createRef();
  }
