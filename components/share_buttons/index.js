      ...
      <>
        <div className={"boxShare " + props.class}>
          <div className="col-3 m-0 p-0 py-2 w-100 h-100">
            ...
            >
              <div className="whatsApp my-auto ml-2" />
              <span className="my-auto pl-1">Share</span>
            </div>
          </div>
          ...
          <div className="col-3 m-0 p-0 py-2 w-100 h-100">
            ...
            >
              <div className="twitter my-auto ml-2" />
              <span className="my-auto pl-1">Tweet</span>
            </div>
          </div>
          <div className="col-3 my-auto w-100 h-100 m-0 p-0 py-2">
            <div
            ...
            >
              <div className="flip my-auto ml-2" />
              <span className="my-auto pl-1">Flip</span>
            </div>
          </div>
        </div>
      </>
