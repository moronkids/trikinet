...
import { useNewsLatest_ } from "redux/api/news";
...
export async function getServerSideProps({ params }) {
  const todos = await useNewsLatest_(1);
  const newsLatest = todos.data;
  let headlineLatestNews_1 = await newsLatest[0];
  let headlineLatestNews_2 = await newsLatest[1];
