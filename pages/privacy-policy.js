...
const Privacy = () => {
  return (
    <div className="container pt-5 staticpage">
      <h3 className="pb-3">Privacy Policy</h3>
      <p>
        PT Digital Startup Nusantara (“us”, “we”, or “our”) operates{" "}
        <a href="/">https://trikinet.com</a> (the “Site”). This page informs you
      ...
      <p>
        DailySocial.id is a participant of several affiliate advertising
        program. You may see some of the advertisements on the site and some of
        the links in the articles are affiliate links which means we collect a
        small percentage of the sale as commission.
      </p>
      <p>
      ...
      <p>
        This Privacy Policy is effective as of 15 February 2016 and will remain
